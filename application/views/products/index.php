            ...
            <div class="col-md-12">
                ...
                <div class="col-md-12">
                    ...
                    <div class="table-container">
                        ...
                        <table class="table table-striped table-bordered table-hover " id="product-tbl"
                               data-url="<?php echo site_url('products/get_all');?>">
                            <thead>
                            <tr>
                            ...
                            <tr role="row" class="filter">
                                <td class="filter-cw-td">
                                    <select  class="form-control  form-filter category_name" name="category_name">
