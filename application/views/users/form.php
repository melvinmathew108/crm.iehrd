        ...
        <div class="row">
            ...
            <div class="col-md-12">
            	...
            	<form role="form" class="form-horizontal" method="post">
                    ...
                    <div class="form-group <?php echo form_error('group_id')?'has-error':'';?>">
                        ...
                        <div class="col-md-5">
                            <select class="form-control" id="group_id" name="group_id">
                                ...
                                <?php foreach($groups as $row_group){
                                    if($row_group->id == 1){
                                        continue;
                                    }
                                    ?>
                                    <option value="<?php echo $row_group->id; ?>" <?php echo ($row['group_id']==$row_group->id)?"selected":''; ?>><?php echo $row_group->title; ?></option>
                                <?php } ?>
                    ...
                    <div class="form-group <?php echo form_error('branch_id')?'has-error':'';?>">
                        <label class="col-md-2 control-label" for="branch_id">Branch<span class="required" aria-required="true"> * </span></label>
                        <div class="col-md-5">
                            <select class="form-control" id="branch_id" name="branch_id">
                                <option value="">Select</option>

                                <?php foreach($array_branch as $row_branch){ ?>
                                    <option value="<?php echo $row_branch->id; ?>"
                                        <?php echo ($row['branch_id']==$row_branch->id)?"selected":''; ?>>
