           				...
           				<div class="col-md-12">
                            ...
                            <select name="group_id" id="group_id" class="form-control">
                                ...
                                <?php foreach($groups as $row_group){ ?>
                                    <option value="<?php echo $row_group->id; ?>" <?php echo ($search['group_id']==$row_group->id)?"selected":''; ?>><?php echo $row_group->title; ?></option>
                                <?php } ?>
                        ...
                        <?php if( is_array($result) && count($result) > 0 ){?>
                            ...
                            <tr>
                                ...
                                <td class="text-center"> 
                                    <a class="btn btn-outline btn-circle btn-sm blue" href="<?php echo site_url('users/edit/'.encrypt($row->id));?>">
                                    ...
                                    <?php if($row->group_id == 2 ){ ?>

                                        <a class="btn btn-outline btn-circle btn-sm blue"
                                           href="<?php echo site_url('users/targets/'.encrypt($row->id));?>">
                                            <i class="fa fa-eye"></i> Monthly Targets </a>
