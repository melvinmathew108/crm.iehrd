    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <form method="post" action="<?php echo site_url('city');?>" class="form-inline">
                    <div class="row">
                        <div class="col-md-12">
                ...
                <div class="row">
                    <a style="margin: 15px" class="pull-right btn btn-info col-md-2"
                       href="<?php echo site_url('city/create'); ?>" >ADD NEW</a>
                </div>
                        ...
                        ?>
                            ...
                            <tr>
                                ...
                                <td class="text-center"> 
                                    <a class="btn btn-outline btn-circle btn-sm blue" href="<?php echo site_url('city/edit/'.encrypt($row->id));?>">
                                    <i class="fa fa-edit"></i> Edit </a>
                                    
                                    <a class="btn btn-outline btn-circle btn-sm red" href="<?php echo site_url('city/delete/'.encrypt($row->id));?>" onclick="if(!confirm('Are you sure you want to delete this forever?')) return false;" >
