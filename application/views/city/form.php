    ...
    <div class="page-content">
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                	<a href="<?php echo site_url('admin/state');?>">District</a>
                    <i class="fa fa-circle"></i>
                </li>    
                <li>   
                    <span>New</span>
        ...
        <!-- END PAGE BAR -->
        <!-- BEGIN PAGE TITLE-->
        <h3 class="page-title"> New District<hr /></h3>
                    ...
                    <div class="form-group <?php echo form_error('country_id')?'has-error':'';?>">
                        ...
                        <div class="col-md-5">
                            <select class="form-control country_id" name="country_id"
                                    data-url="<?php echo site_url('city/get_state');?>">
                        ...
                        <div class="col-md-5">
                            <select class="form-control" name="state_id" id="state_id">
                                ...
                                <?php foreach ($arr_state as $key => $state) { ?>
                                    <option <?php echo($state->id==$row['state_id'])?'selected':''; ?>
