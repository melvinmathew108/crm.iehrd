            ...
            <div class="col-md-12">
            	...
            	<form role="form" class="form-horizontal" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group" style="display: none">
                        <label class="col-md-3 control-label" for="gstin">GSTIN </label>
                        <div class="col-md-5">
                            <input type="text" name="gstin" placeholder="GSTIN" id="gstin" class="form-control"
                                   value="<?php echo $settings->gstin;?>">

                        </div>
                    </div>

                    <div class="form-group" style="display: none">
                        <label class="col-md-3 control-label" for="invoice_prefix">Invoice Prefix </label>
                        <div class="col-md-5">
                            <input type="text" name="invoice_prefix" placeholder="Invoice Prefix" id="invoice_prefix" class="form-control"
                                   value="<?php echo $settings->invoice_prefix;?>">

                        </div>
                    </div>

                    <div class="form-group" style="display: none">
                        <label class="col-md-3 control-label" for="invoice_start">Invoice Starting No </label>
                        <div class="col-md-5">
                            <input type="text" name="invoice_start" placeholder="Invoice Starting No" id="invoice_start" class="form-control"
                                   value="<?php echo $settings->invoice_start;?>">
