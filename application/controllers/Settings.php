...
class Settings extends My_Controller {
    ...
    public function printer() {
        ...
        $this->data['page_title'] = 'Settings';
        $this->data['menu'] = 'settings';
        $this->data['submenu'] = 'printer';

        $this->data['settings'] = $this->common->get( "printer_settings" );

        if($_POST) {

            $this->common->update('printer_settings', $_POST );
            $this->session->set_flashdata('msg','Printer settings updated successfully!');
            redirect('settings/printer');
        }

        $this->load->view('templates/header',$this->data);
        $this->load->view('templates/sidebar',$this->data);
        $this->load->view('settings/printer',$this->data);
        $this->load->view('templates/footer',$this->data);
    }
